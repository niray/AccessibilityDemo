package accessbility.huway.com.lequaccessbilitydemo.services;
...
import accessbility.huway.com.lequaccessbilitydemo.AccessibilityActivity;
...
public class HongbaoService extends AccessibilityService {
    ...
    private static final String DD_VIEW_OTHERS_CH = "个人红包";
    private final static String DD_NOTIFICATION_TIP = "[红包]";
...
//            Toast.makeText(HongbaoService.this, "Request CLICK", Toast.LENGTH_SHORT).show();
        ...
        if (mNeedUnpack && (mUnpackNode != null)) {
            ...
            Rect r = new Rect();
            cellNode.getBoundsInScreen(r);
            String cmd = String.format("input swipe %d %d %d %d", r.centerX(), r.centerY(), r.centerX(), r.centerY());
            AccessibilityActivity.execRootCmd(cmd);
//            Toast.makeText(HongbaoService.this, "Request CLICK", Toast.LENGTH_SHORT).show();
    ...
    private boolean watchList(AccessibilityEvent event) {
        ...
        List<AccessibilityNodeInfo> nodes = event.getSource().findAccessibilityNodeInfosByText(DD_NOTIFICATION_TIP);
        if (!nodes.isEmpty()) {
...
//                Toast.makeText(HongbaoService.this, "Request CLICK", Toast.LENGTH_SHORT).show();
    ...
    private boolean watchNotifications(AccessibilityEvent event) {
        ...
        if (!tip.contains(DD_NOTIFICATION_TIP)) return true;
    ...
    private void checkNodeInfo() {
        ...
        if (node2 != null && node2.getClassName().equals("android.widget.ImageButton")) {
            mUnpackNode = node2;
            mNeedUnpack = true;
            return;
        }
